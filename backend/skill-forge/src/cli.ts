...
program
  .name("skill-forge")
  .description("Unified skill authoring tool for Cursor and Codex")
  .version("1.0.0");
...
program
  ...
  .requiredOption("-t, --target <target>", "Target platform: cursor, codex, or all")
...
program
  ...
  .requiredOption(
    "-t, --target <target>",
    "Target platform: cursor or codex"
  )
