...
program
  ...
  .requiredOption("-t, --target <target>", "Target platform: cursor, codex, windsurf, claude, kiro, trae, qoder, workbuddy, or all")
...
program
  ...
  .requiredOption("-f, --from <source>", "Source platform: cursor, codex, windsurf, claude, kiro, trae, qoder or workbuddy")
...
program
  ...
  .requiredOption(
    "-t, --target <target>",
    "Target platform: cursor, codex, windsurf, claude, kiro, trae, qoder or workbuddy"
  )
